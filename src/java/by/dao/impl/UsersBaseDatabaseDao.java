...
import by.entity.UserBase;
import java.sql.*;

public class UsersBaseDatabaseDao implements ItemDao<UserBase> {
    ...
    public UsersBaseDatabaseDao() throws DaoException {
        try {
            ...
            throw new DaoException("Error in UsersBaseDatabaseDao");
        }
    }
